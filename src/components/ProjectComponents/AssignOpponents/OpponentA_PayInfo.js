...
const OpponentAPayInfo = ({ values, handleChange }) => {
    return (
        <FormContainer>
                            ...
                            <Box className='formfields__Sfieldset'>
                                <Stack spacing='8px' className='form_wrap'>
                                    ...
                                    <fieldset>
                                        <Input
                                            type='text'
                                            value={values.mobileSubscriberName}
...
export default OpponentAPayInfo
